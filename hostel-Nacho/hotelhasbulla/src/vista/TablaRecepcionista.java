...
public class TablaRecepcionista extends JFrame {
    ...
    public TablaRecepcionista() {
        ...
        JButton btnCancha = new JButton("Gestionar canchas");
        btnCancha.setBounds(50, 250, 300, 40);
        btnCancha.setFont(buttonFont);
        btnCancha.setBackground(Color.RED);
        btnCancha.setForeground(Color.BLACK);
        contentPane.add(btnCancha);
